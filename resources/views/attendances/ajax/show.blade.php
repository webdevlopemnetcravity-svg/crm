...
<div class="modal-body bg-grey">
    <div class="row">
        <div class="col-md-12 mb-4">
            ...
            <div class = "img_box">
                <h2 class = "clock_tittle">Clock In Photo</h2>
                <a href="{{ asset('images/clockin_photos/' . $attendance->clock_in_image) }}" target="_blank"> <img class="clock_image" src="{{ asset('images/clockin_photos/' . $attendance->clock_in_image) }}" 
     alt="Clock-In Photo" 
