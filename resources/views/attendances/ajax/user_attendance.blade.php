        ...
        <tr>
            <td>
                <div class="media-body">
                    <h5 class="mb-0 f-13">{{ $currentDate->translatedFormat(company()->date_format) }}</h5>
            ...
            <td>
                {{ $attendance->totalTime($attendance->clock_in_time, $attendance->clock_out_time, $attendance->user_id) }}
            </td>
